...
# форматирование
cellPass = workbook.add_format(dict(bg_color='#99ff33'))
cellFail = workbook.add_format(dict(bg_color='#E13C3C', bold=True))
...
chart.set_style(24)  # Стиль графиков
chart.set_plotarea(dict(
    border={'color': '#E13C3C', 'width': 2, 'dash_type': 'dash'},
    fill={'color': '#D9FDA6'}
))
